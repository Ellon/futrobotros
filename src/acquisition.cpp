...
Acquisition::Acquisition(ros::NodeHandle& n, ros::NodeHandle& pn)
 : FutData(n), ImBruta(IMAGE_WIDTH,IMAGE_HEIGHT)
#ifndef _SO_SIMULADO_
  // ,Camera()
  //  ,Camera(CAM_FUTROBOT),
...
#endif
{
  // Parse width from rosparam
  // string width_str;
  // if (pn.getParam("width", width_str))
  // {
  //   istringstream ss(width_str);
  //   ss >> width;
  //   if (ss.fail())
  //   {
  //     throw std::logic_error(string("Value ") + width_str + string(" for parameter ") + pn.resolveName("width") + string(" is not valid!"));
  //   }
  // }
  // else
  // {
  //   throw std::logic_error(string("Parameter ") + pn.resolveName("width") + string(" not set!"));
  // }

  // // Parse height from rosparam
  // string height_str;
  // if (pn.getParam("height", height_str))
  // {
  //   istringstream ss(height_str);
  //   ss >> height;
  //   if (ss.fail())
  //   {
  //     throw std::logic_error(string("Value ") + height_str + string(" for parameter ") + pn.resolveName("height") + string(" is not valid!"));
  //   }
  // }
  // else
  // {
  //   throw std::logic_error(string("Parameter ") + pn.resolveName("height") + string(" not set!"));
  // }
...
#ifndef _SO_SIMULADO_
  RDistortion = new DistRadial(Width(),Height());
